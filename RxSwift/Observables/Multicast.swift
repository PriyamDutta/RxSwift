...
final private class ConnectableObservableAdapter<S: SubjectType>
    ...
    override func subscribe<Observer: ObserverType>(_ observer: Observer) -> Disposable where Observer.Element == S.Element {
...
final private class MulticastSink<S: SubjectType, Observer: ObserverType>: Sink<Observer>, ObserverType {
    typealias Element = Observer.Element 
    typealias ResultType = Element
    typealias MutlicastType = Multicast<S, Observer.Element>
