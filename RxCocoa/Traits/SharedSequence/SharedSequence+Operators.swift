...
extension SharedSequence {
     ...
     */
    public static func zip<Collection: Swift.Collection, R>(_ collection: Collection, resultSelector: @escaping ([Element]) throws -> R) -> SharedSequence<SharingStrategy, R>
        where Collection.Element == SharedSequence<SharingStrategy, Element> {
...
extension SharedSequence {
    /**
     ...
     - returns: An observable sequence containing the result of combining elements of the sources using the specified result selector function.
     */
    public static func combineLatest<Collection: Swift.Collection, R>(_ collection: Collection, resultSelector: @escaping ([Element]) throws -> R) -> SharedSequence<SharingStrategy, R>
        where Collection.Element == SharedSequence<SharingStrategy, Element> {
